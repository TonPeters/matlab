...
%% cut off data
% figure; plot_tdiff(time,ref1)
% shift = 2;
% shift2 = 13;
% indices.p1 = find(time>6-shift & time<37-shift2);
% indices.n1 = find(time>41-shift & time<72-shift2);
% indices.p2 = find(time>76-shift & time<107-shift2);
% indices.n2 = find(time>111-shift & time<142-shift2);
% 
...
% u = [u1, u2];
% 
% save(['data_friction_new/',filename,'.mat'],'ref','enc','u','time','indices')
