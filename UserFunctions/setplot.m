...
%   Changes: 
%   20120205 - Bugfix: FontName does not change on Resize (Michael Ronde)
...
% MRonde 20120205 double escape for fontname (for eval and set command)
% eval(['set(',num2str(fig),',''ResizeFcn'',''setplot(',num2str(fig),',[],{',num2str(topmargin),',',num2str(bottommargin),',',num2str(rowsmargin),',',num2str(leftmargin),',',num2str(rightmargin),',',num2str(colsmargin),'},',num2str(fontsize),',','''''',fontname,'''''',');'');']);  
