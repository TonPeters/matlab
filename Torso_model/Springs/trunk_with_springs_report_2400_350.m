...
for ii = 1:2
    for i=1:2
        for j=1:2
            ...
            % motor limits
            ph_l_g((i-1)*2+j,:) = plot(th_2_lim,F_lim_trunk,'--','color',ps.list_div_XL{end,end-5}); 
            ph_l((i-1)*2+j,:) = plot(th_2_lim,F_lim2_trunk,'--','color',ps.list_div_XL{3,7}); 
        end
...
if fig_save
    ...
    dir_file = '/home/ton/Dropbox/Linux/Report_final/Images/Torso/trunk_with_springs_350_2400';
