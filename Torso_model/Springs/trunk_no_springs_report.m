...
for i=1:2
    for j=1:2
        ...
        for k=1:length(q0)
            %% Run simulation
            F_trunk = sim_trunk2(q0(k),q2,qd(i),qdd,m_4,M_4(j),N_trunk,F1_trunk);
        ...
        M_4c = 0;
        qdc = -1;
        F_trunkc = sim_trunk2(q0c,q2c,qd(i),qdd,m_4,M_4(j),N_trunk,F1_trunk);
        ph_c((i-1)*2+j) = plot(q2c./pi*180,F_trunkc,'color',ps.tuegreen); hold all;
...
leg_list = {'$q_0$ min','$q_0$ max','center','motor limits'};
...
if fig_save
    ...
    dir_file = '/home/ton/Dropbox/Linux/Report_final/Images/Torso/trunk_no_springs';
