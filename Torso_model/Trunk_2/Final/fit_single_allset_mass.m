...
%     Ksp = param(4);
    ...
    % model calculation
    tau_est_p{meas,set} = cost_trunk_mass(param,q2_est,zeros(size(q2_est)),dat_m2,dat_q0_offset,1);
    tau_est_n{meas,set} = cost_trunk_mass(param,q2_est,zeros(size(q2_est)),dat_m2,dat_q0_offset,-1);
