...
%     for set = sets
        % model calculation
        tau_est_p{meas,set} = cost_trunk_fricCD(param,q2_est,zeros(size(q2_est)),sdata{meas}.m2,sdata{meas}.q_offset,1);
        tau_est_n{meas,set} = cost_trunk_fricCD(param,q2_est,zeros(size(q2_est)),sdata{meas}.m2,sdata{meas}.q_offset,-1);
