...
% clear parameters
clearvars -except g l_1 l_2 l_3 l_F1 l_F2 th_2_min th_2_max th_0_min th_0_max g m_3 l_cm3 l_cm2 l_cm1 m_1 m_2 m_3
plotsettings

%% Settings
m_4 = 30+10;            % mass of the arms
...
% potential terms
G_g = sym_partial_derivative(V,q).';
G = G_g;
...
% save('../Simulation/model_tau_arne_Load.mat','tau_D','tau_C','tau_G','Tau','D','Sinv');
