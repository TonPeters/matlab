...
subplot(3,1,2); plot(time,[qd0_r,qd_sp0,qd_m0]); ylabel('velocity [rad/s]');
subplot(3,1,3); plot(time,[qdd0_r,qdd_sp0,qdd_m0]); ylabel('acceleration [rad/s2]');
...
%% Simulation
load model_tau_noSprings_ms20.mat
...
figure
subplot(3,1,1);
plot(time,qdd0_r); ylabel('qdd ref [rad/s2]');
subplot(3,1,2);
plot(time,Tau(1,:),time,tau_C_num(1,:),time,tau_D_num(1,:),time,tau_G_num(1,:),time,Tau_m); hold all;
