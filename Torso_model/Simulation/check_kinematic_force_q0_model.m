...
h_ref = figure; scr rt;
subplot(3,1,1); plot(time,q0_r); ylabel('angle [rad]');
subplot(3,1,2); plot(time,qd0_r); ylabel('velocity [rad/s]');
subplot(3,1,3); plot(time,qdd0_r); ylabel('acceleration [rad/s2]');
linkaxes(get(h_ref,'children'),'x');

%% torques and forces
% compute joint torque needed
disp('start D');
T_joint = double((subs(tau_D(1),{'q0','q2','qdd0','qdd2'},{q0_r.',q2_r.',qdd0_r.',qdd2_r.'}))).';
disp('end D');
