...
problem = createOptimProblem('lsqnonlin','objective',...
    @(param)cost_single_f1(param,sdata{meas}.q0_s{set},sdata{meas}.tau_f{set},sdata{meas}.q2),...
...
tau_est = -cost_single_f1(param,sdata{meas}.q0_s{set},zeros(size(sdata{meas}.q0_s{set})),sdata{meas}.q2);
figure(fig1);
