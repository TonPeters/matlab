...
% clear parameters
clearvars -except g l_1 l_2 l_3 l_F1 l_F2 th_2_min th_2_max th_0_min th_0_max g m_1 m_2 m_3 l_cm1 l_cm2 l_cm3
plotsettings
...
f2 = cos(q0);
fq0 = cos(q0).*C2.*f1;
fm1 = g*m_1*(l_cm1*cos(q0)).*f1;

% angle q1
C3 = g*(P2+l_2*m4);
f3 = (dq1_q0-1).*cos(q1-q0);
fq1 = (dq1_q0-1).*cos(q1-q0).*C3.*f1;
fm2 = g*m_2.*(l_1.*cos(q0)+l_cm2.*cos(q1-q0).*(dq1_q0-1)).*f1;

% angle q2
C4 = g*(P3+l_3*m4);
f4 = (1-dq1_q0).*cos(q2-q1+q0+q2_gravity_offset);
fq2 = (1-dq1_q0).*cos(q2-q1+q0+q2_gravity_offset).*C4.*f1;
fm3 = g*m_3.*(l_1.*cos(q0)+l_2.*cos(q1-q0).*(dq1_q0-1)+l_cm3.*cos(q2-q1+q0).*(1-dq1_q0)).*f1;
...
plot(q0,f2,q0,f3,q0,f4,q0,f2+f3)
ylabel('f nonlin [-]');
...
figure(fig5);
subplot(2,1,1)
plot(q0,fq0,q0,fq1,q0,fq2,q0,ftot)
legend('meas','meas','P1','P2','P3','tot');
ylabel('motor torque Nm');
subplot(2,1,2)
plot(q0,fm1,q0,fm2,q0,fm3,q0,fmtot)
legend('meas','meas','m1','m2','m3','tot');
ylabel('motor torque Nm');
