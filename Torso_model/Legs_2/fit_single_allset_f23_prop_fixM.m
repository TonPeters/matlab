...
for meas = measurements
    for set = sets
        ...
        problem = createOptimProblem('lsqnonlin','objective',...
            @(param)cost_single_f23_coul_prop_fixM(param,sdata{meas}.q0_s{set},sdata{meas}.tau_f{set},sdata{meas}.q2,sdata{meas}.qd0{set}),...
        ...
        tau_est{meas,set} = -cost_single_f23_coul_prop_fixM(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,sdata{meas}.qd0{set});
