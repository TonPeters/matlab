...
P_est = [P1_est,P2_est,P3_est,P4_est,P5_est,P6_est];
...
problem = createOptimProblem('lsqnonlin','objective',...
    @(param)cost_legs_fricLS_mass_comb_P6(param,dat_q0,dat_tau,dat_q2,dat_qd0),...
...
for meas = measurements
    ...
    % model calculation
    tau_est_p{meas,set} = -cost_legs_fricLS_mass_comb_P6(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,0.004);
    tau_est_n{meas,set} = -cost_legs_fricLS_mass_comb_P6(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,-0.004);
