...
for meas = measurements
    ...
    % model calculation
    tau_est_p{meas,set} = -cost_legs_fricCD(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,0.004);
    tau_est_n{meas,set} = -cost_legs_fricCD(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,-0.004);
