...
for meas = measurements
    ...
    for set = sets
        ...
        problem = createOptimProblem('lsqnonlin','objective',...
            @(param)cost_single_fric2(param,sdata{meas}.q0_s{set},sdata{meas}.tau_f{set},sdata{meas}.q2,sdata{meas}.qd0{set}),...
...
%         P4 = 2.4724;                      % P4 = lcm3*m3 +l3*m4
        ...
        % model calculation
        tau_est{meas,set} = -cost_single_fric2(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,sdata{meas}.qd0{set});
