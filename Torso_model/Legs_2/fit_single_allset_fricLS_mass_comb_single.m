...
for meas = measurements
    ...
    for set = sets
        ...
        dat_q0 = sdata{meas}.q0_s{set};
        dat_qd0 = ones(size(sdata{meas}.q0_s{set})).*sdata{meas}.qd0{set};
        dat_q2 = ones(size(sdata{meas}.q0_s{set})).*sdata{meas}.q2;
        ...
        % model calculation
        tau_est_p{meas,set} = -cost_legs_fricLS_mass_comb(param,q0_est,zeros(size(q0_est)),sdata{meas}.q2,mean(dat_qd0));
